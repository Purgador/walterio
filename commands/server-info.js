...
verifLevels = {
        ...
        MEDIUM: "Medio",
        HIGH: "Alto",
        VERY_HIGH: "Muy Alto :red_circle:ERY_HIGH:"
    },
 region = {
    ...
    .addField("_Bots_", guild.members.cache.filter(member => member.user.bot).size, true)
    .addField("_Roles_", guild.roles.cache.size, true)
    .addField("_Nivel de verificación_", verifLevels[guild.verificationLevel], true)
